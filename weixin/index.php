...
class wechatCallbackapiTest
{
    ...
    private function receiveText($object)
    {
        ...
        if (strstr($keyword, "文本")){
            ...
            $content = array();
            $content[] = array("Title"=>"单图文标题",  "Description"=>"单图文内容", "PicUrl"=>"http://www.goodjobs.cn/images/logo.gif", "Url" =>"http://www.goodjobs.cn/");
            ...
            $content = date("当前时间 Y-m-d H:i:s",time())."\n\n".'<a href="http://goodjobs.cn">技术支持 新安人才网php培训班第8期</a>';
        }
